...
const trust = [
  { icon: Lock, title: "End-to-end encrypted", desc: "All sync traffic is encrypted in transit and at rest." },
  { icon: Eye, title: "Read-only by default", desc: "We never send, modify, or delete email without your consent." },
  { icon: RefreshCw, title: "Revoke any time", desc: "One click in Settings disconnects Repeatless and purges data." },
];
  ...
  return (
    ...
    >
      ...
      <div className="mt-7 space-y-3">
        {trust.map((t) => (
          <div key={t.title} className="flex items-start gap-3 rounded-xl border border-border bg-card px-4 py-3">
