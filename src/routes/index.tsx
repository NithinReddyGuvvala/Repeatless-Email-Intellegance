...
import { ArrowRight, Sparkles, ShieldCheck, MessagesSquare, Inbox, Tags, FileText } from "lucide-react";
    ...
    <div className="min-h-dvh bg-background">
      <header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-10">
        ...
        <nav className="hidden items-center gap-8 text-sm text-charcoal-soft md:flex">
          ...
          <a href="#security" className="hover:text-charcoal">Security</a>
          <Link to="/signin" className="hover:text-charcoal">Sign in</Link>
        </nav>
        <Link to="/signup">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <h1 className="font-serif text-[44px] font-semibold leading-[1.05] tracking-tight text-charcoal sm:text-[56px] lg:text-[64px]">
              The intelligent layer<br />on top of your inbox.
            </h1>
            <p className="mt-6 max-w-xl text-[17px] leading-relaxed text-charcoal-soft">
              Repeatless AI connects securely to Gmail and turns thousands of
              emails into clear summaries, organised threads, and a chat agent
              that knows your correspondence in detail.
            </p>
            ...
            <div id="security" className="mt-10 flex flex-wrap items-center gap-6 text-xs text-muted-foreground">
          ...
          <div className="surface-lifted relative overflow-hidden p-6">
            ...
            <div className="mt-4 rounded-xl border border-border bg-card p-5">
              ...
              <p className="text-[14.5px] leading-relaxed text-charcoal">
                Eleanor finalised the Q4 review agenda with three open
                decisions. Sofia flagged that the <span className="font-semibold">Madrid
                lease renews on July 3</span> and depends on the Berlin office
                call. Marcus proposed the production cutover for{" "}
                <span className="font-semibold">June 28</span>, tracking 18%
                under budget.
              </p>
      ...
      <section id="features" className="mx-auto max-w-7xl px-6 pb-24 lg:px-10">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            { icon: MessagesSquare, title: "Chat with your email", desc: "Ask anything across all history." },
          ].map((f) => (
